      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <!-- <img alt="image" src="assets/upload/profile" class="rounded-circle mr-1"> -->
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> FAIRY CAMP</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">RCM</a>
          </div>
          <ul class="sidebar-menu">
              <li><a class="nav-link" href="<?= base_url("admin/dashboard"); ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>

              <li><a class="nav-link" href="<?= base_url("admin/data_camp"); ?>"><i class="fa fa-shopping-bag"></i> <span>Data Barang</span></a></li>
