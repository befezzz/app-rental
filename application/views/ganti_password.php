        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?= base_url('assets/assets_shop/'); ?>/img/lg.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>

            <div class="card card-dark">
              <div class="card-header"><h4 style="color: black;">Ganti Password</h4></div>

             <span class="mt-2"> <?= $this->session->flashdata('pesan'); ?></span>
            ...
            <div class="simple-footer">
              Copyright &copy; <script>document.write(new Date().getFullYear());</script> Code Pelita rplsmksa
            </div>
          </div>
        </div>
      </div>
